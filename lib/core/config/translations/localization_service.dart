...
class LocalizationService extends Translations {
  ...
  // supported languages
  static Map<String, String> supportedLanguagesText = {
    'en': 'English',
    'ar': 'العربية',
  };
  ...
  // static LocaleType getCurrentLocaleType() =>
  //     MySharedPref.getCurrentLocal().languageCode == 'ar'
  //         ? LocaleType.ar
  //         : LocaleType.en;

  static bool isSelectedStartLanguage() =>
      MySharedPref.isSelectedStartLanguage();
}
