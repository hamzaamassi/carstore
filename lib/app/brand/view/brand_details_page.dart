...
import 'package:e_commerce_car/app/brand/widget/all_tab_widget.dart';
...
class BrandDetailsPage extends GetView<BrandController> {
  ...
  Widget build(BuildContext context) {
    ...
    controller.brandId = arguments["brandId"];
    controller.brandName = arguments["brandName"];
                  ...
                  children: [
                    GeneralListHorizontalCard(
                      ...
                      itemBuilder: (context, index) {
                        final list = controller.brandCar[index];
                    ...
                    DefaultTabController(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            height: Get.height *
                                0.6, // You can adjust the height here as needed
