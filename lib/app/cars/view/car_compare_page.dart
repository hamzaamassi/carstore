...
import 'package:e_commerce_car/widgets/car_compare_card.dart';
...
class CarsComparePage extends GetView<CarsCompareController> {
  const CarsComparePage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // return GetBuilder<CarsCompareController>(
    //   init: CarsCompareController(),
    //   builder: (controller) {
    //     return Scaffold(
    ...
    //                       list: ListCar,
    //                       heightSizedBox: calculateGridHeight(ListCar, 190, 20, 2),
    //                       mainAxisExtent: 200,
    //                       showMoreText: '',
